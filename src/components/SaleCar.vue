    ...
    <div class="sell-area">
      <div class="sell-center">
        ...
        <div class="sell-search">
          ...
          <el-button @click="centerDialogVisible = true" class="sell-btn1 sell-btn">高速卖车</el-button>
          <el-dialog
            title="请填写爱车信息"
        ...
        <div class="sell-newcar">
          <a href="https://xinche.guazi.com/www/fyc">首付10%，爆款新车直接带回家 ></a>
        </div>
      </div>
    </div>
    <!-- <div class="sell-cars">
...
<script lang="ts">
  ...
  import { salecar } from '../api/sale-car/index'
